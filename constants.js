...
var TREATMENT_PRODUCTS = {
    fertilizer: [
        ...
        { id: 'andersons-core-24-6-12', name: 'Andersons Core™ 24-6-12', brand: 'The Andersons', activeIngredient: 'N-P-K 24-6-12 with iron and micronutrients', rate: '2.9 lbs per 1,000 sq ft', rateValue: 2.9, rateUnit: 'lbs', ratePer: 1000, timing: 'Spring/Summer/Fall', notes: 'All-purpose professional-grade fertilizer. 4:1:2 NPK ratio with micronutrients and iron for deep greening. Quick + slow release nitrogen — feeds up to 8 weeks. Reapply every 6–8 weeks during growing season. Works on all grass types. Requires 0.2" water to activate.', sizes: ['6,200 sq ft ($47.88)', '15,500 sq ft ($89.88)'], affiliateUrl: 'https://andersonslawn.com/products/core-24-6-12', affiliateSource: 'https://andersonslawn.com/products/core-24-6-12' },
        { id: 'andersons-contec-dg-18-3-18', name: 'Andersons Contec DG® 18-3-18', brand: 'The Andersons', activeIngredient: 'N-P-K 18-3-18 homogenous DG granule', rate: '3.6 lbs per 1,000 sq ft', rateValue: 3.6, rateUnit: 'lbs', ratePer: 1000, timing: 'Growing season', notes: 'Professional-grade fertilizer ideal for low-cut turf (Bermudagrass, Zoysia). Homogenous granules — every granule contains full NPK blend. DG Technology penetrates dense canopy and thatch. Quick + slow release nitrogen, feeds up to 8 weeks. All turf types safe. Reapply every 6–8 weeks.', sizes: ['5,000 sq ft ($64.88)'], affiliateUrl: 'https://andersonslawn.com/products/contec-dg-18-3-18', affiliateSource: 'https://andersonslawn.com/products/contec-dg-18-3-18' },
        { id: 'andersons-hydra-charge-4-2-0', name: 'Andersons Hydra Charge® 4-2-0', brand: 'The Andersons', activeIngredient: 'N-P-K 4-2-0 with dual surfactant + iron (biosolid)', rate: '8 lbs per 1,000 sq ft', rateValue: 8, rateUnit: 'lbs', ratePer: 1000, timing: 'During drought/water restrictions', notes: 'Biosolid fertilizer + dual surfactant for drought stress. Block copolymer surfactant aids water penetration; polyacrylamide surfactant retains root zone moisture. Quick + slow release nitrogen, feeds up to 6 weeks. Ideal during drought or water restrictions. Cumulative response — reapply every 4–6 weeks. Contains iron — sweep off driveways (do NOT rinse with water, will stain). Not for sale in MD.', sizes: ['2,250 sq ft ($54.88)', '5,000 sq ft ($89.88)'], affiliateUrl: 'https://andersonslawn.com/products/hydra-charge-4-2-0', affiliateSource: 'https://andersonslawn.com/products/hydra-charge-4-2-0' },
        { id: 'andersons-lean-green-2-0-0', name: 'Andersons Lean & Green® 2-0-0', brand: 'The Andersons', activeIngredient: 'N-P-K 2-0-0 with 10% iron (ferrous sulfate Fe2+)', rate: '3.6 lbs per 1,000 sq ft', rateValue: 3.6, rateUnit: 'lbs', ratePer: 1000, timing: 'Summer (supplemental)', notes: 'Iron supplement/fertilizer for deep greening without excessive growth. Uses ferrous sulfate (Fe2+) — not affected by soil pH, unlike most iron products. Ideal for summer stress when turf is dull. Cumulative response — reapply every 4 weeks. Use as a supplement alongside main fertilizer program. All turf types. Contains iron — sweep off hard surfaces immediately (stains). Do not apply during drought without irrigation.', sizes: ['5,000 sq ft ($59.88)', '10,000 sq ft ($89.88)'], affiliateUrl: 'https://andersonslawn.com/products/lean-and-green-2-0-0', affiliateSource: 'https://andersonslawn.com/products/lean-and-green-2-0-0' },
    ...
    postemergent: [
        ...
        { id: 'andersons-surge-weed-feed', name: 'Andersons Surge® Weed & Feed 16-0-9', brand: 'The Andersons', activeIngredient: '4-way broadleaf herbicide blend (16-0-9 NPK)', rate: '2.75 lbs per 1,000 sq ft', rateValue: 2.75, rateUnit: 'lbs', ratePer: 1000, target: '250+ broadleaf weeds', notes: 'Post-emergent weed control + fertilizer. Eliminates 250+ broadleaf weeds including dandelion, clover, chickweed. Apply to WET lawn in morning dew; DO NOT water for 24 hours after. Not for Floratam St. Augustine, dichondra, carpetgrass, bentgrass, or lawns with desirable clover. Do not apply above 85°F. Wait 30 days before seeding after application.', sizes: ['16,000 sq ft ($89.88 regular / $71.90 sale)'],
          grassWarning: { types: ['st-augustine'], message: 'Not labeled for Floratam St. Augustine grass.' },
          affiliateUrl: 'https://andersonslawn.com/products/surge-weed-and-feed-16-0-9', affiliateSource: 'https://andersonslawn.com/products/surge-weed-and-feed-16-0-9' },
    ...
    fungicide: [
        ...
        { id: 'andersons-prophesy', name: 'Andersons Prophesy® Fungicide', brand: 'The Andersons', activeIngredient: 'Azoxystrobin + Propiconazole (DG granular)', rate: '2 lbs per 1,000 sq ft', rateValue: 2, rateUnit: 'lbs', ratePer: 1000, target: 'Brown patch, dollar spot, snow mold', notes: 'Broad-spectrum granular fungicide. Controls/suppresses brown patch, dollar spot, snow mold, and other common lawn diseases. Best used as preventative; also works as curative/rescue treatment. DG Technology for improved soil penetration. For foliar diseases: apply to wet/moist foliage, do not water for 24h. For soil-borne diseases: apply to dry foliage then water in. Bermudagrass sensitive — do not exceed 5 lbs/1,000 sq ft every 30 days. Safe for seeding.', sizes: ['10,000 sq ft ($69.88)'], affiliateUrl: 'https://andersonslawn.com/products/prophesy', affiliateSource: 'https://andersonslawn.com/products/prophesy' },
    ...
    insecticide: [
        ...
        { id: 'andersons-duocide', name: 'Andersons DuoCide® Insect Control', brand: 'The Andersons', activeIngredient: 'Bifenthrin + Carbaryl (DG granular)', rate: '2 lbs per 1,000 sq ft', rateValue: 2, rateUnit: 'lbs', ratePer: 1000, target: 'Grubs, ticks, fire ants, mole crickets, fleas (50+ pests)', notes: 'Eliminates 50+ lawn pests above and below the surface — grubs, ticks, fire ants, mole crickets, fleas. Dual-mode formula: bifenthrin (surface) + carbaryl (subsurface). Treatment only — does NOT prevent insects. Apply when pests are actively present. Water in IMMEDIATELY after application. Grub activity typically April–May and Aug–Oct. Not for sale in California. Safe for seeding.', sizes: ['9,000 sq ft ($51.88)', '20,000 sq ft ($92.88)'], affiliateUrl: 'https://andersonslawn.com/products/duocide', affiliateSource: 'https://andersonslawn.com/products/duocide' },
    ...
    soilAmendment: [
        ...
        { id: 'andersons-humic-dg', name: 'Andersons Humic DG™', brand: 'The Andersons', type: 'Soil Health', activeIngredient: '70% humic acid (humate source)', rate: '2–4 lbs per 1,000 sq ft', rateValue: 2, rateMax: 4, rateUnit: 'lbs', ratePer: 1000, effect: 'Improves nutrient uptake, root mass, seed germination', notes: 'Organic carbon soil amendment. 70% humic content (vs. ~12% average competitors). OMRI listed for organic use. Feeds beneficial soil microbes, chelates nutrients to improve fertilizer efficiency, improves root mass and seed germination. Cumulative response — reapply every 3–4 weeks for best results. Safe for all turf and soil types. Pets/kids safe immediately after application. Not for sale in SD.', sizes: ['11,000 sq ft ($44.88)', '40,000 sq ft ($89.88)'], affiliateUrl: 'https://andersonslawn.com/products/humic-dg', affiliateSource: 'https://andersonslawn.com/products/humic-dg' },
